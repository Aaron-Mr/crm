...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#bundBtn").click(function () {
			...
			if ($xz.length == 0){
				...
				// 要发起的链接：//workbench/clue/bund.do?cid=xxx&aid=xxx&aid=xxx&aid=xxx
				var param = "cid=${c.id}&";
	...
	//刷新线索详细信息页中市场活动列表
	function showClueActivityRelation() {

		//取消搜索框、搜索出来的市场活动记录、复选框
		$("#aname").val("");
		$("#activityListBody").html("");
		/*$("#qxBox").prop("checked",false);*/
		var i = $("input[name=qx]:checked");
		i.prop("checked",false);


		$.ajax({
			url:"workbench/clue/getActivityByClue.do",
			type:"post",
			dataType:"json",
			data:{
				"id":"${c.id}"
					...
					<div class="modal-body">
						...
						<table id="activityTable" class="table table-hover" style="width: 900px; position: relative;top: 10px;">
							...
							<tr style="color: #B3B3B3;">
								<td><input type="checkbox" name="qx" id="qxBox"/>1</td>
								<td>名称</td>
								<td>开始日期</td>
								<td>结束日期</td>
								<td>所有者</td>
